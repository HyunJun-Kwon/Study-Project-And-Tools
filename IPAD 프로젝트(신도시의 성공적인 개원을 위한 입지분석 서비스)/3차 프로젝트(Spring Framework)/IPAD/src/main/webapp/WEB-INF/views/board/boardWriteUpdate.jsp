...
<body>
	...
	<form
		action="${pageContext.request.contextPath}/board/boardWriteUpdateCheck.do"
		method="post">
		...
		<c:forEach var="bDto" items="${list}">
						...
						<div class="col-12">
							...
							<tr id="qWriteTable">
								...
								<td><input type="text" name="subject" required
									id="inputType" placeholder="${bDto.subject }"></td>
							</tr>
							<tr id="qWriteTable">
								<td id="qWriteTableName">이메일</td>
								<td><input type="text" name="email" id="inputType"
							...
							<tr id="qWriteTable">
								...
								<td><input type="password" name="password" required
									id="inputType" placeholder="비밀번호를 입력해주세요."></td>
							</tr>
							<tr id="qWriteTable">
								<td id="qWriteTableName">글내용</td>
								<td><textarea placeholder="내용을 입력해주세요" required
										name="content" placeholder="${bDto.content }"></textarea></td>
							</tr>
						</div>
					</table>
				</div>
					...
					<table>
						<div class="col-12">
							<tr style="height: 100px;">
								...
								<td><input type="file" name="img" id="inputFile" width="">
								</td>
							</tr>
						</div>
					</table>
			...
			<div class="qWBottom">
				<input type="hidden" name="num" value="${bDto.num }"> <input
					type="hidden" name="pass" value="${bDto.password }">
