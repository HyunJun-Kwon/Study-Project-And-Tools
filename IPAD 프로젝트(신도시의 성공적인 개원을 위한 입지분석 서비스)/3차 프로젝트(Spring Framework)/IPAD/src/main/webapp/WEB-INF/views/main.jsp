<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<body class="vh-100 overflow-hiddden">
		...
		<%@ include file="/WEB-INF/views/common/header.jsp" %>
			...
			<!--carousel ------------------------------------------------------------->
			<div>
				<div id="mainCarousel" class="carousel slide mb-6" data-bs-ride="carousel" data-bs-interval="4000">
					<!-- 하단 현재위치  -->
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="${pageContext.request.contextPath}/img/carousel1.jpg" alt="">
							<div class="container">
						...
						<div class="carousel-item">
							<img src="${pageContext.request.contextPath}/img/carousel2.jpg" alt="">
							<div class="container">
								<div class="carousel-caption text-start">
									<div id="title">주거 인구 예측 서비스</div>
									<div id="detail" class="col-xs-12 col-sm-12 col-lg-6">
										주택 · 인구 데이터 분석을 통해 주거 인구 예측</div>
						...
						<!-- carousel page3 -->
						<div class="carousel-item">
							<img src="${pageContext.request.contextPath}/img/carousel3.jpg" alt="">
							<div class="container">
								<div class="carousel-caption text-start">
					...
					<div class="container">
						<div class="row">
							<div id="analysisLeft" class="col-lg-6 ">
								<img src="${pageContext.request.contextPath}/img/mainFirstContent1.png" alt="">
							</div>
							<div id="analysisRight" class="col-lg-6 ">
								<div>
									<h2>인구 분석</h2>
									<img src="${pageContext.request.contextPath}/img/mainFirstContent2.jpg" alt="">
									<h6>
					...
					<div id="content2Bottom" class="container">
						<div class="row">
							<div id="content2Left" class="col-lg-6">
								<img src="${pageContext.request.contextPath}/img/mainSecondContent1.png" alt="">
							</div>
							<div id="content2Right" class="col-lg-6">
								<div>
									<div>
										<img src="${pageContext.request.contextPath}/img/mainSecondContent2.png" alt="">
									</div>
									<div>
										<img src="${pageContext.request.contextPath}/img/mainSecondContent3.png" alt="">
									</div>
								</div>
								<div>
									<div>
										<img src="${pageContext.request.contextPath}/img/mainSecondContent4.png" alt="">
									</div>
									<div>
										<img src="${pageContext.request.contextPath}/img/mainSecondContent5.png" alt="">
									</div>
								</div>
							</div>
						</div>
			...
			<div class="container">
				<div class="row">
					...
					<div id="boardLeft" class="col-lg-6">
						<img src="${pageContext.request.contextPath}/img/mainThirdContent.jpg" alt="">
					</div>
