<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/mainMap.css">
    ...
    <body>
        <%@ include file="/WEB-INF/views/common/header.jsp" %>
            ...
            <div class="container">
                <div class="col-12">
                    <form action="${pageContext.request.contextPath}/member/loginPageCheck.do" method="post" name="frm"
                        ...
                        <div class="loginClickTable">
                            <input type="submit" class="btn btn-primary" id="loginClick" for="btn-check"
                                value="로그인"></input>
                        </div>
                    </form>
                </div>
