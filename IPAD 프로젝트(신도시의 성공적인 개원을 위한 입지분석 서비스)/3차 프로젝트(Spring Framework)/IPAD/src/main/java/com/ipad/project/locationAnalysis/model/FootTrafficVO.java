...
public class FootTrafficVO {
	...
	public FootTrafficVO(String adm_cd, String quater, String population_total, String population_mon,
			...
			String population_sat, String population_sun, BigDecimal rnum, String region_name_detail) {
		this.adm_cd = adm_cd;
		this.quater = quater;
		...
		this.rnum = Integer.valueOf(String.valueOf(rnum));
	...
	public void setPopulation_total(String population_total) {
		this.population_total = String.valueOf((int) Double.parseDouble(population_total));
	}
	...
	public void setPopulation_mon(String population_mon) {
		this.population_mon = String.valueOf((int) Double.parseDouble(population_mon));
	}
	...
	public void setPopulation_tues(String population_tues) {
		this.population_tues = String.valueOf((int) Double.parseDouble(population_tues));
	}
	...
	public void setPopulation_wed(String population_wed) {
		this.population_wed = String.valueOf((int) Double.parseDouble(population_wed));
	}
	...
	public void setPopulation_thur(String population_thur) {
		this.population_thur = String.valueOf((int) Double.parseDouble(population_thur));;
	}
	...
	public void setPopulation_fri(String population_fri) {
		this.population_fri = String.valueOf((int) Double.parseDouble(population_fri));
	}
	...
	public void setPopulation_sat(String population_sat) {
		this.population_sat = String.valueOf((int) Double.parseDouble(population_sat));
	}
	...
	public void setPopulation_sun(String population_sun) {
		this.population_sun = String.valueOf((int) Double.parseDouble(population_sun));
	}
