...
public class ResidentPopulationVO {
	...
	public ResidentPopulationVO() {
		// TODO Auto-generated constructor stub
	}

	public ResidentPopulationVO(String adm_cd, String year, String population_total, String population_male,
	...
	public String toString() {
		return "ResidentPopulationVO [adm_cd=" + adm_cd + ", year=" + year + ", population_total=" + population_total
				+ ", population_male=" + population_male + ", population_female=" + population_female
				+ ", population_10=" + population_10 + ", population_20=" + population_20 + ", population_30="
				+ population_30 + ", population_40=" + population_40 + ", population_50=" + population_50
				+ ", population_60=" + population_60 + ", population_70=" + population_70 + ", region_name_detail="
				+ region_name_detail + "]";
	}
